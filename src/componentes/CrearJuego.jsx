...
const CrearJuego = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${API_BASE_URL}/desarrolladores`)
      .then((response) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${API_BASE_URL}/crearJuego`, formData, {
        headers: {
                  ...
                  {desarrolladores.map((desarrollador) => (
                    ...
                    >
                      <Form.Check
                        ...
                        checked={desarrolladoresSeleccionados.includes(
                  ...
                  {generos.map((genero) => (
                    <div key={genero.id_genero} className="checkbox-item">
                      <Form.Check
                        ...
                        checked={generosSeleccionados.includes(
                          genero.id_genero
                        )}
                        onChange={() =>
                          handleCheckboxChange(
